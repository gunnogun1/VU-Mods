Events:Subscribe('Level:Loaded', function()
	...
	for i,weapon in pairs(CustomizationUnlockParts(CustomizationTable(ruAssault.weaponTable).unlockParts[1]).selectableUnlocks) do 
		if i <= 11 then
	...
	for i,weapon in pairs(CustomizationUnlockParts(CustomizationTable(usAssault.weaponTable).unlockParts[1]).selectableUnlocks) do
		if i <= 11 then
			--print("Changed Engineer")
